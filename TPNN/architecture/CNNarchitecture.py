...
from TPNN.tools.arrays_tools import *
from TPNN.architecture.optimizers import Optimizer
from TPNN.architecture.data import *
...
class CNNlayer(Layer):
    ...
    def print_der_config(self):
        ...
        print_arrays(self.x_derivatives_array, space * 3, max_line_size)
        print(space * 2 + "cores derivatives:")
        print_arrays(self.cores_weights_derivatives, space * 3, max_line_size)
        print(space * 2 + "biases derivatives:")
        print_arrays(self.biases_derivatives, space * 3, max_line_size)
        print()
...
class DenseLayer(Layer):
    ...
    def print_der_config(self):
        ...
        print_arrays(self.weights_der_array, space * 3, max_line_size)
        print(space * 2 + "biases derivatives:")
        print_arrays(self.biases_der_array, space * 3, max_line_size)
        print()
